...
GRPCore.RegisterServerCallback('grp-keys:checkOwner', function(source, cb, plate)
...
AddEventHandler('garage:giveKey', function(target, plate)
  ...
  local xPlayer = GRPCore.GetPlayerFromId(targetSource)
  local ident = xPlayer.getIdentifier()
  local xPlayer2 = GRPCore.GetPlayerFromId(source)
