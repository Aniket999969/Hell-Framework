...
RegisterServerEvent('grp-chopshop:addCash')
AddEventHandler('grp-chopshop:addCash', function()
...
GRPCore.RegisterServerCallback('grp-chopshop:isdead', function(source, cb)
...
GRPCore.RegisterServerCallback('grp-chopshop:getVehInfos', function(source, cb, plate)
