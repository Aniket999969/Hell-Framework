...
GRPCore.RegisterServerCallback('grp-garage:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
AddEventHandler('garages:CheckForSpawnVeh', function(veh_id, garageCost)
  ...
  AddEventHandler('onResourceStart', function(resource)
	if GetCurrentResourceName() == 'grp-garage' then
  ...
  RegisterServerEvent('grp-garage:putcaringarage')
  AddEventHandler('grp-garage:putcaringarage', function()
	if GetCurrentResourceName() == 'grp-garage' then
		Citizen.CreateThread(function()
			Citizen.Wait(1)
			ImpoundCarOut()
