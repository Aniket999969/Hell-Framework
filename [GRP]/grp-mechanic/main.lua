...
Citizen.CreateThread(function()
      while true do
       ...
       if GRPCore.PlayerData.job and GRPCore.PlayerData.job.name == "mechanic" then
...
AddEventHandler("mech:tools", function(args)
    ...
    elseif args[1] == "add" then
        if exports["grp-inventory"]:hasEnoughOfItem(args[2],1,false) then
    ...
    if GRPCore.PlayerData.job and GRPCore.PlayerData.job.name == "mechanic" then
        ...
        if not notfucked then
            ...
            TaskPlayAnim(playerped,"mp_car_bomb","car_bomb_mechanic",8.0, -8, -1, 49, 0, 0, 0, 0)
                ...
                local finished = exports["grp-taskbar"]:taskBar(15000,"Repairing")
