...
if exports["grp-inventory"]:getQuantity("slaughtered_chicken") >= 2 then
	...
	exports['grp-taskbar']:taskBar(7500, 'Putting the chicken in the box')
...
if exports["grp-inventory"]:getQuantity("alive_chicken") >= 1 then
local dict = 'anim@amb@business@coc@coc_unpack_cut_left@'
	...
	exports['grp-taskbar']:taskBar(10000, 'Cutting the Rooster')
end
...
if exports["grp-inventory"]:getQuantity("packaged_chicken") >= 1 then
local x,y,z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.9, -0.98))
	...
	exports['grp-taskbar']:taskBar(5000, 'Selling the chicken!')
