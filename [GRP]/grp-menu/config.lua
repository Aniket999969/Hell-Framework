...
rootMenuConfig =  {
    {
        ...
        icon = "#globe-europe",
        enableMenu = function()
            isDead = exports["grp-ambulancejob"]:GetDeath()
            return not isDead
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["grp-ambulancejob"]:GetDeath()
            return (GRPCore.GetPlayerData().job.name == 'police' and not isDead)
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["grp-ambulancejob"]:GetDeath()
            return not isDead and GRPCore.GetPlayerData().job.name == 'police'
        end
    },
    {
        id = "police-vehicle",
        ...
        enableMenu = function()
            isDead = exports["grp-ambulancejob"]:GetDeath()
            return (GRPCore.GetPlayerData().job.name == 'police' and not isDead and IsPedInAnyVehicle(PlayerPedId(), false))
        end,
        ...
        enableMenu = function()
            ...
            if not isDead and not IsPlayerFreeAiming(PlayerId()) and not IsPedInAnyVehicle(PlayerPedId(), false) and not isHandcuffed and not isHandcuffedAndWalking then
                if GRPCore.GetPlayerData().job.name == 'police' then
                     return true
                elseif exports["grp-inventory"]:hasEnoughOfItem("cuffs",1,false) then
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["grp-ambulancejob"]:GetDeath()
         return (not isDead and not isHandcuffed and not isHandcuffedAndWalking and (exports["grp-inventory"]:hasEnoughOfItem("cuffs",1,false) or GRPCore.GetPlayerData().job.name == 'police'))
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["grp-ambulancejob"]:GetDeath()
            return (GRPCore.GetPlayerData().job.name == 'ambulance' and not isDead)
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            downed = exports["grp-ambulancejob"]:GetDeath()
            return GRPCore.GetPlayerData().job.name == 'police' and downed end
    },
    {
        id = "policeDeadB",
        displayName = "10-13B",
    ...
    },
    {
        ...
        enableMenu = function()
            downed = exports["grp-ambulancejob"]:GetDeath()
            return GRPCore.GetPlayerData().job.name == 'ambulance' and downed end
    },
    {
        id = "emsDeadB",
        displayName = "10-14B",
    ...
    },
    {
        ...
        icon = "#uber-driver",
        functionName = "grp-uberdelivery:start",
        enableMenu = function()
            downed = exports["grp-ambulancejob"]:GetDeath()
            return GRPCore.GetPlayerData().job.name == 'uberdriver' and not downed end
    },
    {
        id = "uberdriver",
        displayName = "End Delivery",
        icon = "#uber-driver2",
        functionName = "grp-uberdelivery:end",
        enableMenu = function()
            downed = exports["grp-ambulancejob"]:GetDeath()
            return GRPCore.GetPlayerData().job.name == 'uberdriver' and not downed end
    },
...
newSubMenus = {
    ...
    ['general:apartgivekey'] = {
        ...
        functionName = "grp-housing:client:giveHouseKey"
    },
    ['general:apartremovekey'] = {
        title = "Remove Key",
        icon = "#general-apart-givekey",
        functionName = "grp-housing:client:removeHouseKey"
    },
    ['general:askfortrain'] = {
        title = "Request Train",
...
AddEventHandler('warrantsGui', function()
    ...
    --TriggerEvent('grp-mdt:hotKeyOpen')
    ExecuteCommand("mdt")
end)
