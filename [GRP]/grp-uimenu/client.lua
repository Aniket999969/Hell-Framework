callbackData = nil
RegisterNetEvent('grp-uimenu:createMenu')
AddEventHandler('grp-uimenu:createMenu', function(myMenu, cb)
    callbackData = nil
    SendNUIMessage({
        action = "show",
        menu = myMenu
...
--    TriggerEvent("grp-uimenu:createMenu", myListMenu, function(value)
...
--    TriggerEvent("grp-uimenu:createMenu", myMultiMenu, function(value)
...
--    TriggerEvent("grp-uimenu:createMenu", myHoverMenu, function(value)
