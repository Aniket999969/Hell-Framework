...
local function saveVehicle()
	...
	local myCar = GRPCore.Game.GetVehicleProperties(veh)
    TriggerServerEvent('grp-bennysmech:updateVehicle',myCar)  
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("grp-bennysmech:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("grp-bennysmech:purchaseSuccessful")
AddEventHandler("grp-bennysmech:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("grp-bennysmech:purchaseFailed")
AddEventHandler("grp-bennysmech:purchaseFailed", function()
