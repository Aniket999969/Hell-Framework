...
--- Config ---
notWhitelistedMessage = "Please join our discord in order to play on the server. Discord: https://discord.gg/5JaXR7QWuT" -- Message displayed when they are not whitelist with the role
