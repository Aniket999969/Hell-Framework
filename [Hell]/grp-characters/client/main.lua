...
Citizen.CreateThread(function()
    while true do
        ...
        if NetworkIsSessionStarted() then
			...
			TriggerServerEvent("grp-scoreboard:AddPlayer")
			TriggerServerEvent('grp-admin:AddPlayer')
			TriggerServerEvent("grp-scoreboard:AddPlayer")
...
RegisterNetEvent('grp-login:swapcharacter')
AddEventHandler('grp-login:swapcharacter', function()
	TriggerEvent("kashactersC:WelcomePage")
...
local function disconnect()
    TriggerServerEvent("grp-login:disconnectPlayer")
end
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
	...
	if isnew then
		...
		TriggerEvent('grp-identity:showRegisterIdentity')
