...
AddEventHandler('phoneGui', function()
  TriggerEvent('jobssystem:current', function(job)
    if GRPCore.PlayerData.job.name == nil or GRPCore.PlayerData.job.name == "unemployed" or GRPCore.PlayerData.job.name == "trucker" then
...
AddEventHandler('phone:assistNotify', function(id, service, player)
  TriggerEvent('jobssystem:current', function(job)
    ...
    elseif (GRPCore.PlayerData.job.name == 'police' or job == 'news') and (service == 'AIcall27' or service == 'AIcall26' or service == 'AIcall25' or service == 'AIcall24' or service == 'AIcall23' or service == 'AIcall' or service == 'AIcall2' or service == 'AIcall3a' or service == 'AIcall3' or service == 'AIcall4' or service == 'AIcall5' or service == 'AIcall6' or service == 'AIcall7' or service == 'AIcall8' or service == 'AIcall17' or service == 'AIcall18' or service == 'AIcall19' or service == 'AIcall20' or service == 'AIcall21' or service == 'AIcall22' or service == 'AIcall9') then
      if job == 'news' then
        addBlip({service = service, player = player, id = id,jobType = "news"})
        local radiocount = exports["grp-inventory"]:getQuantity("scanner")
...
AddEventHandler('phone:assistClear', function(id,jobsent)
  TriggerEvent('jobssystem:current', function(job)
    if myBlips[id] ~= nil and not myBlips[id].onRoute and (job == jobsent or (GRPCore.PlayerData.job.name == "police" and jobsent == "911")) then
