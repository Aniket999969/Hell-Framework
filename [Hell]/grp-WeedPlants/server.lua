...
function MFD:SyncPlant(plant,delete)
  ...
  while not xPlayer do Citizen.Wait(0); GRPCore.GetPlayerFromId(source); end
...
GRPCore.RegisterServerCallback('MF_DopePlant:GetLoginData', function(source,cb) cb(MFD:GetLoginData(source)); end)
GRPCore.RegisterServerCallback('MF_DopePlant:GetStartData', function(source,cb) while not MFD.dS do Citizen.Wait(0); end; cb(MFD.cS); end)
...
RegisterServerEvent("grp-weedplants:purifiedwater")
AddEventHandler("grp-weedplants:purifiedwater", function(id)
  local xPlayer = GRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); GRPCore.GetPlayerFromId(source); end
...
RegisterServerEvent("grp-weedplants:highgradefert")
AddEventHandler("grp-weedplants:highgradefert", function(id)
  local xPlayer = GRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); GRPCore.GetPlayerFromId(source); end
...
RegisterServerEvent("grp-weedplants:highgrademaleseed")
AddEventHandler("grp-weedplants:highgrademaleseed", function(id)
  local xPlayer = GRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); GRPCore.GetPlayerFromId(source); end
...
RegisterServerEvent("grp-weedplants:highgradefemaleseed")
AddEventHandler("grp-weedplants:highgradefemaleseed", function(id)
  local xPlayer = GRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); GRPCore.GetPlayerFromId(source); end
