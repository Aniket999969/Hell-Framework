        ...
        if dist > 120.0 then
            ...
            if dist < 1.5 and not ActiveRun then
                ...
                if IsControlJustReleased(1,38) then
                    ...
                    exports["grp-taskbar"]:taskBar(5000, "Packaging Tacos")                   
                      CheckWeedRun()
                      ClearPedTasks(lPed)
                end
...
function SetDelivery(foodReq)
    if DeliveryCounter ~= 2 then
        if exports["grp-inventory"]:hasEnoughOfItem(foodReq,1) then
...
if exports["grp-inventory"]:hasEnoughOfItem("weedq", 5) then 
...
-- exports["grp-inventory"]:hasEnoughOfItem("band",150)
...
function AttemptDropOffTaco()
    if exports["grp-inventory"]:hasEnoughOfItem("weedtaco",1) then
        ...
        if exports["grp-inventory"]:hasEnoughOfItem("inkedmoneybag",1) then     
        ...
        elseif exports["grp-inventory"]:hasEnoughOfItem("markedbills",1) then     
            ...
            TriggerEvent("DoLongHudText","Thanks for the extra sauce!")
        elseif exports["grp-inventory"]:hasEnoughOfItem("rollcash",rollcount) then     
            ...
            TriggerEvent("DoLongHudText","Thanks for the extra sauce!")
        elseif exports["grp-inventory"]:hasEnoughOfItem("band",bandcount) then     
...
AddEventHandler("weed:successStart", function()
    ...
    if not exports["grp-inventory"]:hasEnoughOfItem("weedq",weedcost) then
...
function WeedTacoTooLong()
    if exports["grp-inventory"]:hasEnoughOfItem("weed12oz",1) then
        ClearBlips()
        Wait(60000)
        -- new run
