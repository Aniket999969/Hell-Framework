...
function OpenSellMenu()
  ...
  GRPCore.UI.Menu.Open(
      ...
      function(data, menu)
              ...
              TriggerEvent('grp-pawnshop:selljewelscl')
          end
      end,
      function(data, menu)
          menu.close()
...
RegisterNetEvent('grp-pawnshop:selljewelscl')
AddEventHandler('grp-pawnshop:selljewelscl', function()
  if exports['grp-inventory']:hasEnoughOfItem('water', 1) then
    TriggerServerEvent('grp-pawnshop:selljewels')
