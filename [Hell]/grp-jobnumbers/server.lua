...
RegisterServerEvent('grp-jobnumbers:setjobs')
AddEventHandler('grp-jobnumbers:setjobs', function(jobname)
...
function AnnounceJobs()
    ...
    TriggerClientEvent('grp-jobnumbers:setjobs', -1, sendingjobs)
end
