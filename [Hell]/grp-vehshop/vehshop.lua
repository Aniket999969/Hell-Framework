...
local vehshopOwner = {
	...
	menu = {
		...
		["imports"] = {
			...
			name = "imports",
			buttons = {
				 {name = "Audi RS7", costs = 18000, description = {}, model = "rs7"},
				 {name = "AMG GT 63", costs = 88000, description = {}, model = "rmodgt63"},
				 {name = "G Wagon", costs = 56000, description = {}, model = "g65amg"},
				 {name = "BWM I8", costs = 105000, description = {}, model = "i8"},
				 {name = "R820", costs = 98000, description = {}, model = "r820"},
				 {name = "Nissan GTR", costs = 62000, description = {}, model = "gtr"},
				 {name = "FD3S", costs = 50000, description = {}, model = "fd3s"},
				 {name = "EVO 10", costs = 56000, description = {}, model = "evo10"},
				 {name = "Gold Wing", costs = 34000, description = {}, model = "goldwing"},
				 {name = "RS7", costs = 60000, description = {}, model = "rs7c8wb"},
				 {name = "S8D4", costs = 15000, description = {}, model = "s8d4"},
				 {name = "Ninja H2", costs = 40000, description = {}, model = "nh2r"},
				 {name = "Camaro", costs = 71000, description = {}, model = "zl12017"},
				 {name = "Lambo Performate", costs = 135000, description = {}, model = "18performante"},
				 {name = "Range Rover", costs = 59000, description = {}, model = "18Velar"},	 
			}
		},
		["casino"] = {
			title = "casino",
...
local carTable = {
	...
	[2] = { ["model"] = "asea", ["baseprice"] = 100000, ["commission"] = 15 },
	[3] = { ["model"] = "xls", ["baseprice"] = 100000, ["commission"] = 15 },
	[4] = { ["model"] = "bobcatxl", ["baseprice"] = 100000, ["commission"] = 15 },
	[5] = { ["model"] = "surfer", ["baseprice"] = 100000, ["commission"] = 15 },
	[6] = { ["model"] = "bati", ["baseprice"] = 100000, ["commission"] = 15 },
	[7] = { ["model"] = "bmx", ["baseprice"] = 100000, ["commission"] = 15 },
}
...
AddEventHandler("car:testdrive", function()
	...
	local pData = GRPCore.GetPlayerData()
...
function SpawnSaleVehicles()
	if not hasspawned then
		TriggerServerEvent("carshop:table")
...
function CloseCreator(name, veh, price, financed)
	Citizen.CreateThread(function()
		...
		if not boughtcar then
			...
			SetEntityVisible(ped,true)
			local vehProps = GRPCore.Game.GetVehicleProperties(personalvehicle)
