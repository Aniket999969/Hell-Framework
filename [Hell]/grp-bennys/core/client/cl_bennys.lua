...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("grp-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("grp-bennys:purchaseSuccessful")
AddEventHandler("grp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("grp-bennys:purchaseFailed")
AddEventHandler("grp-bennys:purchaseFailed", function()
