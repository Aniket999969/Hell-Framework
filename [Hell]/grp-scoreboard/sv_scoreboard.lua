...
RegisterServerEvent('grp-scoreboard:AddPlayer')
AddEventHandler("grp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("grp-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("grp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("grp-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("grp-scoreboard:RemoveRecent", -1, plyid)
end)
