...
RegisterNetEvent("grp-scoreboard:RemovePlayer")
AddEventHandler("grp-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("grp-scoreboard:AddPlayer")
AddEventHandler("grp-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("grp-scoreboard:RemoveRecent")
AddEventHandler("grp-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("grp-scoreboard:AddAllPlayers")
AddEventHandler("grp-scoreboard:AddAllPlayers", function(data)
